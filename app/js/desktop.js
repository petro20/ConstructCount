...
(function (F) {
  ...
  async function openWorkspaceFromSlug(slug) {
    ...
    const prov = {
      ...
      setWindowDim: (code, w, h, t, m, wadd, hadd, side, swing) => api.set_window_dim(slug, code, w, h, t, m, wadd != null ? wadd : null, hadd != null ? hadd : null, side != null ? side : null, swing != null ? swing : null),
