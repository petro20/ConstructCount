...
(function () {
  ...
  function upsertFinish(kind, code, field, value) {
    ...
    else { rec[field] = value; if (field === 'material') rec.desc = value; if (value && String(value).trim()) rec.userEdited = true; }   // vazio NÃO conta como edição (deixa a legenda preencher)
