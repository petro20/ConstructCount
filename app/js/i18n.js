...
(function (F) {
  ...
  const DICT = {
    ...
    'Oscilo-batente (abre p/ dentro)': { en: 'Tilt & Turn (open in)', es: 'Oscilobatiente (apertura interior)' },
  ...
  const TYPE_I18N = {
    ...
    "Tilt & Turn (open in)": { pt: "Oscilo-batente (abre p/ dentro)", en: "Tilt & Turn (open in)", es: "Oscilobatiente (apertura interior)" },
