...
$GLOBALS['I18N'] = [
  ...
  'how1'=>['Assine um plano','Subscribe to a plan','Suscríbete a un plan'], 'how1d'=>['Pagamento seguro por cartão (Stripe).','Secure card payment (Stripe).','Pago seguro con tarjeta (Stripe).'],
